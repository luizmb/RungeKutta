...
extension Optional {
    public func apply<B>(_ f: Optional<(Wrapped) -> B>) -> B? {
...
public func zip<A, B, C>(_ first: A?, _ second: B?, _ third: C?) -> (A, B, C)? {
    return zip(first, zip(second, third)).map { sideA, sideBC in (sideA, sideBC.0, sideBC.1) }
}

public func zip<A, B, C, D>(_ first: A?, _ second: B?, _ third: C?, _ fourth: D?) -> (A, B, C, D)? {
